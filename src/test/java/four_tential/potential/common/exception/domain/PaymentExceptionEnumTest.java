...
class PaymentExceptionEnumTest {
    ...
    @Test
    @DisplayName("ERR_NOT_FOUND_PAYMENT 는 NOT_FOUND 상태코드를 반환한다")
    ...
    @Test
    @DisplayName("ERR_ALREADY_PAID 는 BAD_REQUEST 상태코드를 반환한다")
    ...
    @Test
    @DisplayName("ERR_PAYMENT_AMOUNT_MISMATCH 는 BAD_REQUEST 상태코드를 반환한다")
    ...
    @Test
    @DisplayName("ERR_WEBHOOK_SIGNATURE_INVALID 는 BAD_REQUEST 상태코드를 반환한다")
    ...
    @Test
    @DisplayName("ERR_PAYMENT_FORBIDDEN 는 FORBIDDEN 상태코드를 반환한다")
    ...
    @Test
    @DisplayName("ERR_REFUND_PROCESS_FAILED 는 INTERNAL_SERVER_ERROR 상태코드를 반환한다")
    ...
    @Test
    @DisplayName("ERR_ALREADY_FULLY_REFUNDED 는 BAD_REQUEST 상태코드를 반환한다")
