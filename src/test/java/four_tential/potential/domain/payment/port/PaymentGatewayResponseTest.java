...
class PaymentGatewayResponseTest {
    ...
    void constructor_pgKey() {
        PaymentGatewayResponse response = new PaymentGatewayResponse(
                "portone_key_123", "PAID", 100000L, "card");
    ...
    void constructor_status_failed() {
        PaymentGatewayResponse response = new PaymentGatewayResponse(
                "portone_key_123", "FAILED", 0L, "card");
    ...
    void constructor_status_cancelled() {
        PaymentGatewayResponse response = new PaymentGatewayResponse(
                "portone_key_123", "CANCELLED", 100000L, "card");
    ...
    @Test
    @DisplayName("생성 시 payMethod 가 card 로 저장된다")
    void constructor_payMethod_card() {
        PaymentGatewayResponse response = new PaymentGatewayResponse(
                "portone_key_123", "PAID", 100000L, "card");
    ...
    @Test
    @DisplayName("생성 시 payMethod 가 easyPay 로 저장된다")
    void constructor_payMethod_easyPay() {
        PaymentGatewayResponse response = new PaymentGatewayResponse(
                "portone_key_123", "PAID", 100000L, "easyPay");
